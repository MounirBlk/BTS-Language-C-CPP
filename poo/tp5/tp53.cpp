...
class Etudiant:public Personne {
    private:
    string classe;
    /* attribut dont chaque case va stocker une note de chaque matière */
    /* paramètré à une note de zéro sur 20 */
    float note[3]={0,0,0};
    public:
    /* constructeur par defaut */
    Etudiant();
...
int main(void){
  ...
  int n=0;
    ...
    */
    ...
    cout<<endl<<endl;
    n=n+1;
    }while (n<N); /* N est une constante, prédéfinie avec define N 2 */
    ...
    /* initialisation de n à zéro à nouveau */
    n=0;
    ...
    cout<<endl<<endl;
    n=n+1;
    }while (n<M); /* M est une constante, prédéfinie avec define M 3 */
