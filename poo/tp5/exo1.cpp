...
void Etudiant::affiche(){
  ...
  noteMoy=(note[0]+note[1]+note[2])/3;
  cout<<"\t Moyenne de l'etudiant : "<<noteMoy<<""<<endl;
...
Enseignant::Enseignant():Personne(){
  cout<<"Combien d'heures de cours avez-vous ?";
  cin>>nbHeuresCours;
  cout<<endl;
}
...
void Enseignant::specialite(){
  ...
  cout<<"\n\n Mme/Mr." <<nom<<" Entrer votre specialite :"<<endl;
  cout<<"\t Entrez la lettre [i] pour Informatique"<<endl;
  cout<<"\t Entrez la lettre [r] pour Reseaux"<<endl;
  cout<<"\t Entrez la lettre [p] pour Projet"<<endl;
...
void Enseignant::options(){
  cout<<"\t Combien d'heures pour le labo ? ";
  cin>> labo;
  cout<<"\t Combien d'heures le suivi ? ";
  cin>> suivi;
  cout<<endl;
}
...
void Enseignant::affiche(){
  cout<<endl;
  cout<<"Mme/Mr." <<nom<< " Vous etes professeur de '"<<matiere<< "'"<<endl;
  cout<<"\t Vous avez :"<<nbHeuresCours<<" heures de cours"<<endl;
